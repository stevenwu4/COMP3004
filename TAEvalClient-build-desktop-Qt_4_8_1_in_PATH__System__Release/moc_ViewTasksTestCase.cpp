...
**
** Created: Sun Dec 8 18:23:57 2013
...
static const char qt_meta_stringdata_ViewTasksTestCase[] = {
    "ViewTasksTestCase\0\0success,testCase\0"
    "complete(bool,int)\0taskList\0"
    "run(std::vector<Task>)\0timeout()\0"
};
...
// SIGNAL 0
void ViewTasksTestCase::complete(bool _t1, int _t2)const
{
